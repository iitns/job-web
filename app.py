...
RESUME_SCHEMA_SQL = """
CREATE TABLE IF NOT EXISTS __RESUME_TABLE__ (
...
CREATE TABLE IF NOT EXISTS __RESUME_PROFILE_TABLE__ (
    resume_id BIGINT PRIMARY KEY REFERENCES __RESUME_TABLE__(id) ON DELETE CASCADE,
    candidate_name TEXT,
    summary TEXT,
...
CREATE INDEX IF NOT EXISTS idx_job_web_resumes_created_at ON __RESUME_TABLE__(created_at DESC);
""".replace("__RESUME_TABLE__", RESUME_TABLE).replace("__RESUME_PROFILE_TABLE__", RESUME_PROFILE_TABLE)
